<%@ Page Title="" Language="C#" MasterPageFile="~/GACC_LiderProyectoEditarProyecto.Master" AutoEventWireup="true" CodeBehind="GACC_LiderProyectoEditarProyecto.aspx.cs" Inherits="GACC_Vista.GACC_LiderProyectoEditarProyecto1" %>
                    ...
                    <td colspan="2">
                            ...
                            <tr>
                                <td style="align-content:center">
                                    <table class="table table-striped table-advance table-hover" style="width:100%">
                                        ...
                                        <asp:Wizard ID="Wizard1" runat="server" ActiveStepIndex="0" class="table table-striped table-advance table-hover" DisplaySideBar="false" OnPreRender="Wizard1_PreRender" ><NavigationButtonStyle  BorderColor="Blue" />
                                            <WizardSteps>
                                                <asp:WizardStep ID="WizardStep1" runat="server" Title="Datos">
                     ...
                     <asp:RequiredFieldValidator ID="RequiredFieldValidator18" runat="server" ErrorMessage="*" ControlToValidate="gacc_ddllenguajes" ForeColor="Red"></asp:RequiredFieldValidator>
                                               <asp:DropDownList ID="gacc_ddllenguajes" runat="server" class="form-control"  >
                                                            <asp:ListItem Text=" LENGUAJE DE PROGRAMACION     "></asp:ListItem>
                     ...
                     <asp:RequiredFieldValidator ID="RequiredFieldValidator19" runat="server" ErrorMessage="*" ControlToValidate="gacc_ddlgestordebase" ForeColor="Red"></asp:RequiredFieldValidator>
                                            ...
                                            <td>
                                                <div class="col-lg-10">
                                                 ...
                                                 <asp:TextBox ID="gacc_lineascodigoexistentes"   runat="server" class="form-control" Text="0" ></asp:TextBox> </div>                                                
                                            ...
                                            <td>
                                                <div class="col-lg-10">
                                                 ...
                                                 <asp:TextBox ID="gacc_txtcostotrabajadores"   runat="server" class="form-control"  Text="0"></asp:TextBox> </div>
                                            </td>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="col-lg-10">
                                                 ...
                                                 <asp:TextBox ID="gacc_txtcostoindirecto"   runat="server" class="form-control" Text="0"></asp:TextBox> </div>
                                                ...
                                                <div class="col-lg-10">
                                                 ...
                                                 <asp:DropDownList ID="gacc_ddltipoproyecto" runat="server" class="form-control"   >
                                                      <asp:ListItem Text="Seleccione El Tipo De Proyecto" ></asp:ListItem>
                                                         ...
                                                         <tr >
                                                             <td colspan="2"><center><asp:LinkButton ID="gacc_lnkcalcular" runat="server" OnClick="gacc_lnkcalcular_Click" class="btn btn-default btn-sm" >Calcular </asp:LinkButton></center></tdc>
                                                         </tr>

                                                     </table>

                                                </asp:WizardStep>
                                    <asp:WizardStep ID="WizardStep2" runat="server" Title="Cálculo " >
                                            <table class="table table-striped table-advance table-hover" style="width:100%" >
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="col-lg-10">
                                                 ...
                                                 <asp:TextBox ID="gacc_fechafin"   runat="server" class="form-control" TextMode="Date"></asp:TextBox> 
                                         ...
                                         <tr>
                                            ...
                                            <td>
                                                <div class="col-lg-10">
                                                 ...
                                                 <asp:TextBox ID="gacc_txtcostototal"   runat="server" class="form-control" Text="0"></asp:TextBox> </div>
                                            </td>
                                        </tr>
