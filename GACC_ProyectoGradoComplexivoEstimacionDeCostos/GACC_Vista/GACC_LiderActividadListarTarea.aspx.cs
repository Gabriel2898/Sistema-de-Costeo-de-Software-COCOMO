...
{
    public partial class GACC_LiderActividadListarTarea1 : System.Web.UI.Page
    {
        ...
        {
            List<GACC_ViewActividadTareaUsuario4> listaproductos = new List<GACC_ViewActividadTareaUsuario4>();
            listaproductos = GACC_ControladorTarea.ObtenerTareaxvistatodo(gacc_lblnombreusuario.Text);
        ...
        {
            Response.Redirect("GACC_LiderActividadInsertarTarea.aspx");
        }

        protected void gacc_lnkbuscar_Click(object sender, EventArgs e)
        {
            List<GACC_ViewActividadTareaUsuario4> list = new List<GACC_ViewActividadTareaUsuario4>();
            GACC_ViewActividadTareaUsuario4 pro = new GACC_ViewActividadTareaUsuario4();
            ...
            if (op != "0")
            {
                ...
                {
                    case "N":
                        pro = GACC_ControladorTarea.ObtenerTareaxvistatodobuscar(gacc_txtbuscar.Text);
                        if (pro != null)
                        {
                            list.Add(pro);
        ...
        protected void gacc_grv_RowCommand(object sender, GridViewCommandEventArgs e)
        {
            ...
            {
                Response.Redirect("GACC_LiderActividadInsertarTarea.aspx?cod=" + codigo, true);
            }
