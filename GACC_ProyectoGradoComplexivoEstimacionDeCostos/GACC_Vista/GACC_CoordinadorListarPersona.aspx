<%@ Page Title="" Language="C#" MasterPageFile="~/GACC_CoordinadorListarPersona.Master" AutoEventWireup="true" CodeBehind="GACC_CoordinadorListarPersona.aspx.cs" Inherits="GACC_Vista.GACC_CoordinadorListarPersona1" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="gacc_cph2" runat="server">
     <asp:LinkButton ID="gacc_lnkbtnsalir" runat="server" OnClick="gacc_btnsalir_Click" >  <i class="icon_key_alt"></i>LogOut
     </asp:LinkButton>
</asp:Content>
                   ...
                   <tr>
                       <td>Buscar por:</td>
                           <td>
                                ...
                                <asp:ListItem Text="Cédula" Value="N"></asp:ListItem>
                                </asp:DropDownList>
                           </td>
                           <td>
                                   ...
                                   <Columns>
                                       <asp:TemplateField HeaderText="Accion" ItemStyle-Width="17" HeaderStyle-Width="17">
                                           <ItemTemplate>
                                               ...
                                               <br /><br />
                                               <asp:LinkButton ID="gacc_lnkeliminar" runat="server" class="btn btn-danger btn-sm"  CommandArgument='<%#Eval("gacc_PerId")%>' CommandName="Eliminar" OnClientClick="return confirm('¿Está seguro de que desea eliminar esta persona?')">Eliminar</asp:LinkButton>
