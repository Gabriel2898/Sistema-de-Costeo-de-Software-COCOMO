...
{
    public partial class GACC_CoordinadorLineasCodigo1 : System.Web.UI.Page
    {
        ...
        private void cargarNombreProyecto()
        {
            ...
            gacc_ddlnombredelproyecto.Items.Insert(0, new ListItem("", "0"));
        }
        ...
        {
            if (gacc_txttiempo.Text == String.Empty)
            {
               
                ScriptManager.RegisterClientScriptBlock(this, this.GetType(), "alertMessage", "alert('Primero Calcule El tiempo, despues proceda a calcular la fecha fin ')", true);
