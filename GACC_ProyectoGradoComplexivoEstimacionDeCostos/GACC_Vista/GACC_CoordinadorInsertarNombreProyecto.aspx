<%@ Page Title="" Language="C#" MasterPageFile="~/GACC_CoordinadorInsertarNombreProyecto.Master" AutoEventWireup="true" CodeBehind="GACC_CoordinadorInsertarNombreProyecto.aspx.cs" Inherits="GACC_Vista.GACC_CoordinadorInsertarNombreProyecto1" %>
            ...
            <table style="width:100%" class="table table-striped table-advance table-hover">
                ...
                <tr>
                    <td>
                        ...
                        <asp:LinkButton ID="gacc_lnklineas" runat="server" OnClick="gacc_lnklineas_Click"  class="btn btn-danger btn-sm" ><i class="fa fa-plus" aria-hidden="true">Agregar Lineas de Código</i></asp:LinkButton>
                                    ...
                                    <table class="table table-striped table-advance table-hover">
                                       ...
                                       <tr>
                                         ...
                                         <tr>
                                            ...
                                            <td>
                                                <div class="col-lg-10">
                                                     <asp:RequiredFieldValidator ID="RequiredFieldValidator2" runat="server" ErrorMessage="*" ControlToValidate="gacc_ddlcargo" ForeColor="Red"></asp:RequiredFieldValidator>
                                         ...
                                         <tr>
                                            ...
                                            <td>
                                                ...
                                                <asp:DropDownList ID="gacc_ddlencargado" runat="server" class="form-control">
                                                </asp:DropDownList> </div>
                                            </td>
                                        </tr>
                                        <tr>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="col-lg-10">
                                                     <asp:RequiredFieldValidator ID="RequiredFieldValidator4" runat="server" ErrorMessage="*" ControlToValidate="gacc_ddlestado" ForeColor="Red" Visible="false"></asp:RequiredFieldValidator>
