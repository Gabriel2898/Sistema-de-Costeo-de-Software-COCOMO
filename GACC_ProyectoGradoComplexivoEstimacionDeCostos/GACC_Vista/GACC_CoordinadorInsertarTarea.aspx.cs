...
{
    public partial class GACC_CoordinadorInsertarTarea1 : System.Web.UI.Page
    {
        ...
        {
            Response.Redirect("GACC_CoordinadorListarTarea.aspx");
        }
        ...
        protected void gacc_ddlcargo_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            //{
            //    List<GACC_TblPersona> listaProveedor = new List<GACC_TblPersona>();
            //    var list = (from persona in dc.GACC_TblPersona where persona.gacc_CodCarId == int.Parse(gacc_ddlcargo.SelectedValue) && persona.gacc_PerEspecialidad == gacc_ddlespecialidad.SelectedValue && persona.gacc_PerEstado == 'D' select persona).ToList();
            //    gacc_ddlpersona.DataSource = list;
            //    gacc_ddlpersona.DataTextField = "Nombres_Completos";
            //    gacc_ddlpersona.DataValueField = "gacc_PerId";
            //    gacc_ddlpersona.DataBind();
