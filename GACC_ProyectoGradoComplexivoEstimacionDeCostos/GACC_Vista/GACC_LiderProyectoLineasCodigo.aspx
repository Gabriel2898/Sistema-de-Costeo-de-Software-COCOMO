<%@ Page Title="" Language="C#" MasterPageFile="~/GACC_LiderProyectoLineasCodigo.Master" AutoEventWireup="true" CodeBehind="GACC_LiderProyectoLineasCodigo.aspx.cs" Inherits="GACC_Vista.GACC_LiderProyectoLineasCodigo1" %>
            ...
            <table style="width:100%" class="table table-striped table-advance table-hover">
                ...
                <tr>
                    <td>
                        ...
                        <asp:LinkButton ID="gacc_lnknombreproyecto" runat="server" OnClick="gacc_lnknombreproyecto_Click"  class="btn btn-danger btn-sm" ><i class="fa fa-plus" aria-hidden="true">Agregar Metodología</i></asp:LinkButton>
                    </td>
                </tr>
                 <tr>
                    <td colspan="2">
                            ...
                            <tr>
                                <td style="align-content:center">
                                    <table class="table table-striped table-advance table-hover" style="width:100%">
                                        ...
                                        <asp:Wizard ID="Wizard1" runat="server" ActiveStepIndex="0" class="table table-striped table-advance table-hover" OnFinishButtonClick="Wizard1_FinishButtonClick"  DisplaySideBar="false" OnPreRender="Wizard1_PreRender"><NavigationButtonStyle  BorderColor="Green" />
                                            <WizardSteps>
...
<table class="table table-striped table-advance table-hover" style="width:100%" >
        ...
        <tr>
         ...
         <tr>
             ...
             <td><center><asp:TextBox ID="gacc_fc1"   runat="server" class="form-control"  Text="" ></asp:TextBox></center> <asp:RequiredFieldValidator ID="RequiredFieldValidator44" runat="server" ErrorMessage="*" ControlToValidate="gacc_fc1" ForeColor="Red" ></asp:RequiredFieldValidator>
         ...
         <tr>
             <td><center><b>Rendimiento</b></center></td>
              <td><center><asp:TextBox ID="gacc_fc2"   runat="server" class="form-control" Text="" ></asp:TextBox></center><asp:RequiredFieldValidator ID="RequiredFieldValidator34" runat="server" ErrorMessage="*" ControlToValidate="gacc_fc2" ForeColor="Red" ></asp:RequiredFieldValidator>
             ...
             <td><center><asp:TextBox ID="gacc_fc3"   runat="server" class="form-control" Text="" ></asp:TextBox></center><asp:RequiredFieldValidator ID="RequiredFieldValidator38" runat="server" ErrorMessage="*" ControlToValidate="gacc_fc3" ForeColor="Red" ></asp:RequiredFieldValidator>
         ...
         <tr>
            <td><center><b>Requisitos de Manejo del Usuario Final</b></center></td>
             <td><center><asp:TextBox ID="gacc_fc4"   runat="server" class="form-control" Text="" ></asp:TextBox></center><asp:RequiredFieldValidator ID="RequiredFieldValidator42" runat="server" ErrorMessage="*" ControlToValidate="gacc_fc4" ForeColor="Red" ></asp:RequiredFieldValidator>
         ...
         <tr>
             ...
             <td><center><asp:TextBox ID="gacc_fc5"   runat="server" class="form-control" Text="" ></asp:TextBox></center><asp:RequiredFieldValidator ID="RequiredFieldValidator45" runat="server" ErrorMessage="*" ControlToValidate="gacc_fc5" ForeColor="Red" ></asp:RequiredFieldValidator>
         ...
         <tr>
            <td><center><b>Facilidad de Mantenimiento </b></center></td>
             <td><center><asp:TextBox ID="gacc_fc6"   runat="server" class="form-control" Text="" ></asp:TextBox></center><asp:RequiredFieldValidator ID="RequiredFieldValidator46" runat="server" ErrorMessage="*" ControlToValidate="gacc_fc6" ForeColor="Red" ></asp:RequiredFieldValidator>
        ...
        <tr>
            <td><center><b>Instalación en Multiples Lugares </b></center></td>
             <td><center><asp:TextBox ID="gacc_fc7"   runat="server" class="form-control" Text="" ></asp:TextBox></center><asp:RequiredFieldValidator ID="RequiredFieldValidator47" runat="server" ErrorMessage="*" ControlToValidate="gacc_fc7" ForeColor="Red" ></asp:RequiredFieldValidator>
        ...
        <tr>
            <td><center><b>Funciones Distribuidas </b></center></td>
             <td><center><asp:TextBox ID="gacc_fc8"   runat="server" class="form-control" Text="" ></asp:TextBox></center><asp:RequiredFieldValidator ID="RequiredFieldValidator48" runat="server" ErrorMessage="*" ControlToValidate="gacc_fc8" ForeColor="Red" ></asp:RequiredFieldValidator>
        ...
        <tr>
            <td><center><b>Gran carga de Trabajo  </b></center></td>
             <td><center><asp:TextBox ID="gacc_fc9"   runat="server" class="form-control" Text="" ></asp:TextBox></center><asp:RequiredFieldValidator ID="RequiredFieldValidator49" runat="server" ErrorMessage="*" ControlToValidate="gacc_fc9" ForeColor="Red" ></asp:RequiredFieldValidator>
          ...
          <tr>
            <td><center><b>Entrada On-Line de Datos  </b></center></td>
             <td><center><asp:TextBox ID="gacc_fc10"   runat="server" class="form-control" Text="" ></asp:TextBox></center><asp:RequiredFieldValidator ID="RequiredFieldValidator50" runat="server" ErrorMessage="*" ControlToValidate="gacc_fc10" ForeColor="Red" ></asp:RequiredFieldValidator>
           ...
           <tr>
            <td><center><b>Actualizaciones On-Line </b></center></td>
             <td><center><asp:TextBox ID="gacc_fc11"   runat="server" class="form-control" Text="" ></asp:TextBox></center><asp:RequiredFieldValidator ID="RequiredFieldValidator51" runat="server" ErrorMessage="*" ControlToValidate="gacc_fc11" ForeColor="Red" ></asp:RequiredFieldValidator>
        ...
        <tr>
            <td><center><b>Utilización con otros Sistemas  </b></center></td>
             <td><center><asp:TextBox ID="gacc_fc12"   runat="server" class="form-control" Text="" ></asp:TextBox></center><asp:RequiredFieldValidator ID="RequiredFieldValidator52" runat="server" ErrorMessage="*" ControlToValidate="gacc_fc12" ForeColor="Red" ></asp:RequiredFieldValidator>
        ...
        <tr>
            <td><center><b>Facilidad de Operación </b></center></td>
             <td><center><asp:TextBox ID="gacc_fc13"   runat="server" class="form-control" Text="" ></asp:TextBox></center><asp:RequiredFieldValidator ID="RequiredFieldValidator53" runat="server" ErrorMessage="*" ControlToValidate="gacc_fc13" ForeColor="Red" ></asp:RequiredFieldValidator>
         ...
         <tr>
            <td><center><b>Facilidad de Cambio </b></center></td>
             <td><center><asp:TextBox ID="gacc_fc14"   runat="server" class="form-control" Text="" ></asp:TextBox></center><asp:RequiredFieldValidator ID="RequiredFieldValidator54" runat="server" ErrorMessage="*" ControlToValidate="gacc_fc14" ForeColor="Red" ></asp:RequiredFieldValidator>
                                            ...
                                            <td>
                                                <div class="col-lg-10">
                                                 ...
                                                 <asp:TextBox ID="gacc_txttiempo"   runat="server" class="form-control" Text="?"></asp:TextBox> 
                                                         <asp:RequiredFieldValidator ID="RequiredFieldValidator64" runat="server" ErrorMessage="*" ControlToValidate="gacc_txttiempo" ForeColor="Red"></asp:RequiredFieldValidator>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <asp:DropDownList ID="gacc_ddlestado" runat="server" class="form-control">
                                                 ...
                                                 <tr >
                                                             <td colspan="2"><center><asp:LinkButton ID="gacc_lnkcalculartodo" runat="server" OnClick="gacc_lnkcalculartodo_Click" class="btn btn-default btn-sm" >Calcular Todo </asp:LinkButton></></td>
