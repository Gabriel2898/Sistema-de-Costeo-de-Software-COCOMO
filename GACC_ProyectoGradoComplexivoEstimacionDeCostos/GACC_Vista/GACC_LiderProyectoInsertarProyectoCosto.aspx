<%@ Page Title="" Language="C#" MasterPageFile="~/GACC_LiderProyectoListarProyectoCosto.Master" AutoEventWireup="true" CodeBehind="GACC_LiderProyectoInsertarProyectoCosto.aspx.cs" Inherits="GACC_Vista.GACC_LiderProyectoInsertarProyectoCosto1" %>
                                ...
                                <td style="align-content:center" >
                                    <table class="table table-striped table-advance table-hover">
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="col-lg-10">
                                                  <asp:DropDownList ID="gacc_ddlcostoindirecto" runat="server" class="form-control"  AutoPostBack="true">
                                                </asp:DropDownList>
                                                 </div>
                                            </td>
                                        </tr>
