<%@ Page Title="" Language="C#" MasterPageFile="~/GACC_CoordinadorListarProyectoPersona.Master" AutoEventWireup="true" CodeBehind="GACC_CoordinadorListarProyectoPersona.aspx.cs" Inherits="GACC_Vista.GACC_CoordinadorListarProyectoPersona1" %>
...
<asp:Content ID="Content4" ContentPlaceHolderID="gacc_cph3" runat="server">
   ...
   <table class="auto-style3">
       ...
       <tr>
           <td class="auto-style4">
               <table  class="table table-striped table-advance table-hover" style="margin-bottom: 63px; width: 93%; height: 444px;">
                   <tr>
                       <td>Buscar por:</td>
                           <td>
