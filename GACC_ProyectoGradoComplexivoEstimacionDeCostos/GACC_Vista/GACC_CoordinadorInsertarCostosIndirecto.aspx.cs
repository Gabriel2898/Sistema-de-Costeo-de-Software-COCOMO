...
{
    public partial class GACC_CoordinadorInsertarCostosIndirecto1 : System.Web.UI.Page
    {
        ...
        {
            Response.Redirect("GACC_CoordinadorListarCostosIndirecto.aspx");
        }
        ...
        {
            Response.Redirect("GACC_CoordinadorInsertarProyecto.aspx");
        }
    }
}