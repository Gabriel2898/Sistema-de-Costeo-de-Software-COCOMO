<%@ Page Title="" Language="C#" MasterPageFile="~/GACC_CoordinadorListarTarea.Master" AutoEventWireup="true" CodeBehind="GACC_CoordinadorListarTarea.aspx.cs" Inherits="GACC_Vista.GACC_CoordinadorListarTarea1" %>
...
<asp:Content ID="Content4" ContentPlaceHolderID="gacc_cph3" runat="server">
   ...
   <table class="auto-style4">
       ...
       <tr>
           <td class="auto-style3">
               <table  class="table table-striped table-advance table-hover" style="margin-bottom: 63px; width: 85%; height: 444px;">
                   <tr>
                       <td>Buscar por:</td>
                           <td>
