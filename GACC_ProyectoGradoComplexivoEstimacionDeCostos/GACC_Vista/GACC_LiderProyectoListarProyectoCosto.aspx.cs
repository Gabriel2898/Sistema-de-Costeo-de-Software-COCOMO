...
{
    public partial class GACC_LiderProyectoListarProyectoCosto1 : System.Web.UI.Page
    {
        ...
        private void cargarNombreProyeccto()
        {
            ...
            var list = (from nombreproyecto in dc.GACC_ViewProyectoCosto where nombreproyecto.gacc_NompId == int.Parse(gacc_ddlnombreproyecto.SelectedValue) select nombreproyecto).ToList();
            if (list != null)
            {
        ...
        protected void gacc_grv_RowCommand(object sender, GridViewCommandEventArgs e)
        {
            ...
            {
                Response.Redirect("GACC_LiderProyectoInsertarProyectoCosto.aspx?cod=" + codigo, true);
            }
