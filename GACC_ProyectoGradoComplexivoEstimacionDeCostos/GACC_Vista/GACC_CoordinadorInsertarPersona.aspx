<%@ Page Title="" Language="C#" MasterPageFile="~/GACC_CoordinadorInsertarPersona.Master" AutoEventWireup="true" CodeBehind="GACC_CoordinadorInsertarPersona.aspx.cs" Inherits="GACC_Vista.GACC_CoordinadorInsertarPersona1" %>
...
<asp:Content ID="Content4" ContentPlaceHolderID="gacc_cph3" runat="server">
    ...
    <asp:HiddenField runat="server" ID="nombre1" />
    <asp:HiddenField runat="server" ID="nombre2" />
    <asp:HiddenField runat="server" ID="apellido1" />
    <asp:HiddenField runat="server" ID="apellido2" />
                                ...
                                <td style="align-content:center">
                                    <table class="table table-striped table-advance table-hover">
                                            ...
                                            <td>
                                                <div class="col-lg-10">
                                                 ...
                                                 <asp:TextBox ID="gacc_txtsegundonombre"   runat="server" class="form-control" MaxLength="50"></asp:TextBox>
                                                    ...
                                                    <asp:RegularExpressionValidator Display = "Dynamic" ControlToValidate = "gacc_txtsegundonombre" ID="RegularExpressionValidator3" ValidationExpression = "^[\s\S]{3,}$" runat="server" ErrorMessage="Minimo 3 Caracteres" ForeColor="Red"></asp:RegularExpressionValidator>
                                                </div>
                                            </td>
                                            ...
                                            <td>
                                                <div class="col-lg-10">
                                                 ...
                                                 <asp:TextBox ID="gacc_txtprimerapellido"   runat="server" class="form-control" MaxLength="50" ></asp:TextBox> 
                                                    ...
                                                    <asp:RegularExpressionValidator Display = "Dynamic" ControlToValidate = "gacc_txtprimerapellido" ID="RegularExpressionValidator4" ValidationExpression = "^[\s\S]{3,}$" runat="server" ErrorMessage="Minimo 3 Caracteres" ForeColor="Red"></asp:RegularExpressionValidator>
                                                </div>
                                            </td>
                                            ...
                                            <td>
                                                <div class="col-lg-10">
                                                 ...
                                                 <asp:TextBox ID="gacc_txtsegundoapellido"   runat="server" class="form-control" MaxLength="50" ></asp:TextBox>
                                                    ...
                                                    <asp:RegularExpressionValidator Display = "Dynamic" ControlToValidate = "gacc_txtsegundoapellido" ID="RegularExpressionValidator5" ValidationExpression = "^[\s\S]{3,}$" runat="server" ErrorMessage="Minimo 3 Caracteres" ForeColor="Red"></asp:RegularExpressionValidator>
                                                    </div>
                                            </td>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="col-lg-10">
                                                        <asp:RequiredFieldValidator ID="RequiredFieldValidator14" runat="server" ErrorMessage="*" ControlToValidate="gacc_ddlgenero" ForeColor="Red"></asp:RequiredFieldValidator>                  
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="col-lg-10">
                                                     <asp:RequiredFieldValidator ID="RequiredFieldValidator15" runat="server" ErrorMessage="*" ControlToValidate="gacc_ddlempresa" ForeColor="Red"></asp:RequiredFieldValidator>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="col-lg-10">
                                                     <asp:RequiredFieldValidator ID="RequiredFieldValidator16" runat="server" ErrorMessage="*" ControlToValidate="gacc_ddlcargo" ForeColor="Red"></asp:RequiredFieldValidator>
