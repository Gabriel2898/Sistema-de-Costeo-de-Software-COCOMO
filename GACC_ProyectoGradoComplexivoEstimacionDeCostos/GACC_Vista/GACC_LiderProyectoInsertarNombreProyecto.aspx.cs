...
{
    public partial class GACC_LiderProyectoInsertarNombreProyecto1 : System.Web.UI.Page
    {
            ...
            try
            {
                ...
                var existe = GACC_ControladorNombreProyecto.Autentificoproyectoxempresa(gacc_txtnombre.Text, Convert.ToInt32(gacc_ddlempresa.Text));
                {
                    ...
                    else
                    {
                        ...
                        {
                            ScriptManager.RegisterClientScriptBlock(this, this.GetType(), "alertMessage", "alert(' Tienes bastante trabajo, termina tus anteriores trabajos para realizar uno nuevo ')", true);
                        }
                    }
                }
            }
        ...
        {
            Response.Redirect("GACC_LiderProyectoListarNombreProyecto.aspx");
        }
        ...
        protected void gacc_lnkmetodologia_Click(object sender, EventArgs e)
        {
