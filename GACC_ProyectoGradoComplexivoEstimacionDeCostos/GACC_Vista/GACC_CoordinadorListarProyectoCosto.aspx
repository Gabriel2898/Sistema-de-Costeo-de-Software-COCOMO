<%@ Page Title="" Language="C#" MasterPageFile="~/GACC_CoordinadorListarProyectoCosto.Master" AutoEventWireup="true" CodeBehind="GACC_CoordinadorListarProyectoCosto.aspx.cs" Inherits="GACC_Vista.GACC_CoordinadorListarProyectoCosto1" %>
                   ...
                   <tr>
                       <td>Buscar por:</td>
                           <td>
                                ...
                                <asp:ListItem Text="Proyecto" Value="N"></asp:ListItem>
                                </asp:DropDownList>
                           </td>
                           <td>
                   ...
                   <tr>
                       <td colspan="4" class="auto-style2">
                           <div class="auto-style5">
                               <asp:GridView ID="gacc_grv" runat="server" AutoGenerateColumns="false" OnRowCommand="gacc_grv_RowCommand" PageSize="5" OnSelectedIndexChanged="gacc_grv_SelectedIndexChanged" Height="20px" Width="1129px" CssClass="mGrid">
