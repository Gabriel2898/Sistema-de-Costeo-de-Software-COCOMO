<%@ Page Title="" Language="C#" MasterPageFile="~/GACC_LiderFaseDeDesarrolloListarActividad.Master" AutoEventWireup="true" CodeBehind="GACC_LiderFaseDeDesarrolloListarActividad.aspx.cs" Inherits="GACC_Vista.GACC_LiderFaseDeDesarrolloListarActividad1" %>
   ...
   <table >
       ...
       <tr>
           <td class="auto-style3">
               <table  class="table table-striped table-advance table-hover" style="margin-bottom: 63px; width: 104%; height: 444px;">
                   <tr>
                       <td>Buscar por:</td>
                           <td>
