...
{
    public partial class GACC_CoordinadorEditarProyecto1 : System.Web.UI.Page
    {
        ...
        private void cargarNombreProyecto()
        {
            ...
            gacc_ddlnombredelproyecto.Items.Insert(0, new ListItem("Nombre Proyecto", "0"));
        }
        ...
        {
            List<GACC_ViewNombreProyectoEmpresa> listaProveedor = new List<GACC_ViewNombreProyectoEmpresa>();
            var list = (from empresa in dc.GACC_ViewNombreProyectoEmpresa where empresa.gacc_EmpId == int.Parse(gacc_ddlempresa.SelectedValue) && empresa.gacc_NompEstado == 'E' select empresa).ToList();
            gacc_ddlnombredelproyecto.DataSource = list;
            gacc_ddlnombredelproyecto.DataTextField = "gacc_NompNombre";
            gacc_ddlnombredelproyecto.DataValueField = "gacc_NompId";
            gacc_ddlnombredelproyecto.DataBind();
        ...
        protected void gacc_lnkcalculartodo_Click(object sender, EventArgs e)
        {
            /*if ((gacc_ddlmodelodeproyecto.SelectedValue == "Básico") && (gacc_ddltipoproyecto.SelectedValue == "Orgánico"))
            {
                ...
                lineascodigo = Convert.ToDouble(gacc_txtlineasdecodigo.Text);
                double totalsalario = Convert.ToDouble(gacc_txtcostotrabajadores.Text);
                double totalcostoindirecto = Convert.ToDouble(gacc_txtcostoindirecto.Text);
                double PM, TD, NP;
                double a = 2.40;
                double b = 1.05;
                double c = 2.50;
                ...
                costoproyecto = Math.Round(totalsalario * esfuerzoajustado, 2);
                costototalproyecto = Math.Round(costoproyecto + totalcostoindirecto, 2);
