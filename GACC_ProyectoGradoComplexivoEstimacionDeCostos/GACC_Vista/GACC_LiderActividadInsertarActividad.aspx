<%@ Page Title="" Language="C#" MasterPageFile="~/GACC_LiderActividadInsertarActividad.Master" AutoEventWireup="true" CodeBehind="GACC_LiderActividadInsertarActividad.aspx.cs" Inherits="GACC_Vista.GACC_LiderActividadInsertarAtividad" %>
                                            ...
                                            <td>
                                                <div class="col-lg-10">
                                                 ...
                                                 <asp:DropDownList ID="gacc_ddlestado" runat="server" class="form-control">
                                                    <asp:ListItem Text="--SELECCIONE ESTADO DE ACTIVIDAD--" ></asp:ListItem>
