...
{
    public partial class GACC_LiderProyectoListarCostosIndirecto1 : System.Web.UI.Page
    {
        ...
        {
            List<GACC_TblCostoIndirecto> listaproductos = new List<GACC_TblCostoIndirecto>();
            var list = (from nombreproyecto in dc.GACC_ViewCosto where nombreproyecto.gacc_CostNombreProyectoID == Convert.ToInt32(gacc_ddlnombreproyecto.SelectedValue) select nombreproyecto).ToList();
            if (list != null)
            {
        ...
        protected void gacc_grv_RowCommand(object sender, GridViewCommandEventArgs e)
        {
            ...
            {
                Response.Redirect("GACC_LiderProyectoInsertarCostosIndirecto.aspx?cod=" + codigo, true);
            }
