<%@ Page Title="" Language="C#" MasterPageFile="~/GACC_CoordinadorInsertarActividad.Master" AutoEventWireup="true" CodeBehind="GACC_CoordinadorInsertarActividad.aspx.cs" Inherits="GACC_Vista.GACC_CoordinadorInsertarActividad1" %>
            ...
            <table style="width:100%" class="table table-striped table-advance table-hover">
                ...
                <tr>
                    <td>
                        ...
                        <asp:LinkButton ID="gacc_lnktarea" runat="server" OnClick="gacc_lnktarea_Click"  class="btn btn-danger btn-sm" ><i class="fa fa-plus" aria-hidden="true">Agregar Tarea</i></asp:LinkButton>
                                    ...
                                    <table class="table table-striped table-advance table-hover">
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                </asp:DropDownList> <asp:RequiredFieldValidator ID="RequiredFieldValidator2" runat="server" ErrorMessage="*" ControlToValidate="gacc_ddlempresa"></asp:RequiredFieldValidator></div>
                                            </td>
                                        </tr>
                                        <tr>
                                            <td>
                                            ...
                                            <td>
                                                <div class="col-lg-10">
                                                    <asp:RequiredFieldValidator ID="RequiredFieldValidator9" runat="server" ControlToValidate="gacc_ddlproyecto" ErrorMessage="*" ForeColor="Red"></asp:RequiredFieldValidator>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="col-lg-10">
                                                    <asp:RequiredFieldValidator ID="RequiredFieldValidator8" runat="server" ControlToValidate="gacc_ddlmetodologia" ErrorMessage="*" ForeColor="Red"></asp:RequiredFieldValidator>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="col-lg-10">
                                                    <asp:RequiredFieldValidator ID="RequiredFieldValidator7" runat="server" ControlToValidate="gacc_ddlfase" ErrorMessage="*" ForeColor="Red"></asp:RequiredFieldValidator>
                                                <asp:DropDownList ID="gacc_ddlfase" runat="server" class="form-control">
                                                </asp:DropDownList> </div>
                                            </td>
                                        </tr>
                                         <tr>
                                            ...
                                            <td>
                                                ...
                                                <asp:DropDownList ID="gacc_ddlcargo" runat="server" class="form-control" AutoPostBack="true" OnSelectedIndexChanged="gacc_ddlcargo_SelectedIndexChanged">
                                                    ...
                                                    <asp:RequiredFieldValidator ID="RequiredFieldValidator3" runat="server" ErrorMessage="*" ControlToValidate="gacc_ddlcargo"></asp:RequiredFieldValidator>
                                                </div>
                                            </td>
                                        </tr>
                                        <tr>
                                            ...
                                            <td>
                                                <div class="col-lg-10">
                                                    <asp:RequiredFieldValidator ID="RequiredFieldValidator6" runat="server" ControlToValidate="gacc_ddlpersona" ErrorMessage="*" ForeColor="Red"></asp:RequiredFieldValidator>
                                         ...
                                         <tr>
                                            ...
                                            <td>
                                                <div class="col-lg-10">
                                                    ...
                                                    <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ControlToValidate="gacc_txtnombre" ErrorMessage="*" ForeColor="Red"></asp:RequiredFieldValidator>
                     
                                                 <asp:TextBox ID="gacc_txtnombre"  runat="server" class="form-control" > </asp:TextBox> </div>
                                            </td>
                                        </tr>
                                          ...
                                          <tr>
                                            ...
                                            <td>
                                                <div class="col-lg-10">
                                                    <asp:RequiredFieldValidator ID="RequiredFieldValidator5" runat="server" ControlToValidate="gacc_ddlestadopersona" ErrorMessage="*" ForeColor="Red"></asp:RequiredFieldValidator>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="col-lg-10">
                                                    <asp:RequiredFieldValidator ID="RequiredFieldValidator4" runat="server" ControlToValidate="gacc_ddlestado" ErrorMessage="*" ForeColor="Red"></asp:RequiredFieldValidator>
