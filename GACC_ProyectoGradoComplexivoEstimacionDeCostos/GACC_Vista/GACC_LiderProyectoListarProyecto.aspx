<%@ Page Title="" Language="C#" MasterPageFile="~/GACC_LiderProyectoListarProyecto.Master" AutoEventWireup="true" CodeBehind="GACC_LiderProyectoListarProyecto.aspx.cs" Inherits="GACC_Vista.GACC_LiderProyectoListarProyecto1" %>
   ...
   <table>
       ...
       <tr>
           <td class="auto-style3">
               <table  class="table table-striped table-advance table-hover" style="margin-bottom: 63px; width: 51%; height: 444px;">
                   <tr>
                       <td>Buscar por:</td>
                           <td>
                                <asp:DropDownList ID="gacc_ddlcriterio" class="form-control" runat="server" Width="100px">
