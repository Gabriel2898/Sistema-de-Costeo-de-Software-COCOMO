<%@ Page Title="" Language="C#" MasterPageFile="~/GACC_LiderProyectoInsertarCostosIndirecto.Master" AutoEventWireup="true" CodeBehind="GACC_LiderProyectoInsertarCostosIndirecto.aspx.cs" Inherits="GACC_Vista.GACC_LiderProyectoInsertarCostosIndirecto1" %>
            ...
            <table style="width:100%" class="table table-striped table-advance table-hover">
                ...
                <tr>
                    <td>
                        ...
                        <asp:LinkButton ID="gacc_lnkcosteo" runat="server" OnClick="gacc_lnkcosteo_Click"  class="btn btn-danger btn-sm" ><i class="fa fa-money" aria-hidden="true">Costeo Proyecto</i></asp:LinkButton>
