<%@ Page Title="" Language="C#" MasterPageFile="~/GACC_CoordinadorListarCargo.Master" AutoEventWireup="true" CodeBehind="GACC_CoordinadorListarCargo.aspx.cs" Inherits="GACC_Vista.GACC_CoordinadorListarCargo1" %>
           ...
           <td>
               <table  class="table table-striped table-advance table-hover" style="margin-bottom: 63px; width: 94%; height: 444px;">
                   <tr>
                       <td>Buscar por:</td>
                           <td>
                                <asp:DropDownList ID="gacc_ddlcriterio" runat="server" Width="95px" class="form-control">
                                   ...
                                   <Columns>
                                       <asp:TemplateField HeaderText="Accion" ItemStyle-Width="17" HeaderStyle-Width="17">
                                           <ItemTemplate>
                                               ...
                                               <asp:LinkButton ID="gacc_lnkeditar" runat="server" class="btn btn-warning btn-sm"  CommandArgument='<%#Eval("gacc_CarId")%>' CommandName="Editar">Editar</asp:LinkButton>
                                               <br /><br />
                                               <asp:LinkButton ID="gacc_lnkeliminar" runat="server" class="btn btn-danger btn-sm"  CommandArgument='<%#Eval("gacc_CarId")%>' CommandName="Eliminar" OnClientClick="return confirm('¿Está seguro de que desea eliminar este cargo?')">Eliminar</asp:LinkButton>
                                       ...
                                       <asp:TemplateField HeaderText="Id" HeaderStyle-CssClass="header-center">
                                           <ItemTemplate>
                                               <asp:Label ID="gacc_CarId" ForeColor="Black" runat="server" text='<%#Eval("gacc_CarId")%>'/>
                                           </ItemTemplate>
                                       ...
                                       <asp:TemplateField HeaderText="Estado" HeaderStyle-CssClass="header-center">
                                           <ItemTemplate>
                                               <asp:Label ID="gacc_CarEstado" ForeColor="Black" runat="server" text='<%#Eval("gacc_CarEstado")%>'/>
                                           </ItemTemplate>
                                           <HeaderStyle CssClass="header-center" />
                                       </asp:TemplateField>
                                   </Columns>
