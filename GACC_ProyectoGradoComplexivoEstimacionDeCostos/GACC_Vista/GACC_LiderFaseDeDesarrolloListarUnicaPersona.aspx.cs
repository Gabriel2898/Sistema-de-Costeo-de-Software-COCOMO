...
{
    public partial class GACC_LiderFaseDeDesarrolloListarUnicaPersona1 : System.Web.UI.Page
    {
        ...
        protected void gacc_grv_RowCommand(object sender, GridViewCommandEventArgs e)
        {
            ...
            {
                Response.Redirect("GACC_LiderFaseDeDesarrolloInsertarPersona.aspx?cod=" + codigo, true);
            }
