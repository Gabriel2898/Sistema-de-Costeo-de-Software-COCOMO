...
{
    public partial class GACC_CoordinadorInsertarProyecto1 : System.Web.UI.Page
    {
        ...
        private void cargarNombreProyecto()
        {
            ...
            var list = (from nombreproyecto in dc.GACC_ViewNombreProyectoEmpresa where nombreproyecto.gacc_EmpId == int.Parse(gacc_ddlempresa.SelectedValue) && nombreproyecto.gacc_NompEstado == 'F' select nombreproyecto).ToList();
