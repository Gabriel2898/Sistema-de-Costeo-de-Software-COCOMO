<%@ Page Title="" Language="C#" MasterPageFile="~/GACC_LiderActividadListarTarea.Master" AutoEventWireup="true" CodeBehind="GACC_LiderActividadListarTarea.aspx.cs" Inherits="GACC_Vista.GACC_LiderActividadListarTarea1" %>
...
<asp:Content ID="Content4" ContentPlaceHolderID="gacc_cph3" runat="server">
   ...
   <table class="auto-style3">
       ...
       <tr>
           <td>
               <table  class="table table-striped table-advance table-hover" style="margin-bottom: 63px; width: 84%; height: 444px;">
                   <tr>
                       <td>Buscar por:</td>
                           <td>
