<%@ Page Title="" Language="C#" MasterPageFile="~/GACC_CoordinadorListarMetodologia.Master" AutoEventWireup="true" CodeBehind="GACC_CoordinadorListarMetodologia.aspx.cs" Inherits="GACC_Vista.GACC_CoordinadorListarMetodologia1" %>
...
<asp:Content ID="Content4" ContentPlaceHolderID="gacc_cph3" runat="server">
   ...
   <table class="auto-style4">
       ...
       <tr>
           <td class="auto-style3">
               <table  class="table table-striped table-advance table-hover" style="margin-bottom: 63px; width: 96%; height: 547px; margin-right: 12px;">
                   <tr>
                       <td>Buscar por:</td>
                           <td>
