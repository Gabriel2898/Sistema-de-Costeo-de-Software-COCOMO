<%@ Page Title="" Language="C#" MasterPageFile="~/GACC_LiderProyectoInsertarTarea.Master" AutoEventWireup="true" CodeBehind="GACC_LiderProyectoInsertarTarea.aspx.cs" Inherits="GACC_Vista.GACC_LiderProyectoInsertarTarea1" %>
                                    ...
                                    <table class="table table-striped table-advance table-hover">
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <asp:DropDownList ID="gacc_ddlcargo" runat="server" class="form-control" AutoPostBack="true" >
                                                </asp:DropDownList> </div>
                                            </td>
                                        </tr>
