...
{
    public partial class GACC_CoordinadorListarTarea1 : System.Web.UI.Page
    {
        ...
        {
            List<GACC_ViewActividadTarea> listaproductos = new List<GACC_ViewActividadTarea>();
            listaproductos = GACC_ControladorTarea.ObtenerTareaxvista();
        ...
        {
            Response.Redirect("GACC_CoordinadorInsertarTarea.aspx");
        }

        protected void gacc_lnkbuscar_Click(object sender, EventArgs e)
        {
            List<GACC_ViewActividadTarea> list = new List<GACC_ViewActividadTarea>();
            GACC_ViewActividadTarea pro = new GACC_ViewActividadTarea();
            ...
            if (op != "0")
            {
                ...
                {
                    case "N":
                        pro = GACC_ControladorTarea.ObtenerTareaxnombre(gacc_txtbuscar.Text);
                        if (pro != null)
                        {
                            list.Add(pro);
        ...
        protected void gacc_grv_RowCommand(object sender, GridViewCommandEventArgs e)
        {
            ...
            {
                Response.Redirect("GACC_CoordinadorInsertarTarea.aspx?cod=" + codigo, true);
            }
