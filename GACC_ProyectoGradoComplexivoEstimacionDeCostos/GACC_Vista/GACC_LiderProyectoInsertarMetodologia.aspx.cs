...
{
    public partial class GACC_LiderProyectoInsertarMetodologia1 : System.Web.UI.Page
    {
            ...
            if (!IsPostBack)
            {
                ...
                if (Request["cod"] != null)
                {
                    ...
                    if (usuarioInfo != null)
                    {
                        ...
                        gacc_ddlestado.Text = usu.gacc_MetEstado.ToString();
                    ...
                    else
                    {
                        bool existepersona = GACC_ControladorProyectoPersona.AutentificarPersonaProyecto(Convert.ToInt32(gacc_ddlnombreproyecto.SelectedValue), Convert.ToInt32(gacc_ddlencargado.SelectedValue));
                        {
                            ...
                            else
                            {
                                ...
                                {
                                    ScriptManager.RegisterClientScriptBlock(this, this.GetType(), "alertMessage", "alert('Tienes bastante trabajo, Porfavor Terminas tus anteriores trabajos ')", true);
                                }
        ...
        private void Modificar(GACC_TblMetodologia usuarioInfo)
        {
            try
            {
                ...
                usuarioInfo.gacc_MetEstado = Convert.ToChar(gacc_ddlestado.Text);
                usuarioInfo.gacc_MetNombre = gacc_txtnombre.Text;
        ...
        {
            Response.Redirect("GACC_LiderProyectoListarMetodologia.aspx");
        }
        ...
        protected void gacc_ddlcargo_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            List<GACC_ViewPersonaCargoEmpresa2> listaProveedor = new List<GACC_ViewPersonaCargoEmpresa2>();
            var list = (from persona in dc.GACC_ViewPersonaCargoEmpresa2 where persona.gacc_CarId == int.Parse(gacc_ddlcargo.SelectedValue) && persona.gacc_EmpId == int.Parse(gacc_ddlempresa.SelectedValue) && persona.gacc_PerUsuarioNombre == gacc_lblnombreusuario.Text select persona).ToList();
            gacc_ddlencargado.DataSource = list;
            gacc_ddlencargado.DataTextField = "Nombres_Completos";
            gacc_ddlencargado.DataValueField = "gacc_PerId";
            gacc_ddlencargado.DataBind();
