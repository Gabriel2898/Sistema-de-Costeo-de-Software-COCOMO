<%@ Page Title="" Language="C#" MasterPageFile="~/GACC_CoordinadorInsertarProyecto.Master" AutoEventWireup="true" CodeBehind="GACC_CoordinadorInsertarProyecto.aspx.cs" Inherits="GACC_Vista.GACC_CoordinadorInsertarProyecto1" %>
                            ...
                            <tr>
                                <td style="align-content:center">
                                    <table class="table table-striped table-advance table-hover" style="width:100%">
                                        ...
                                        <asp:Wizard ID="Wizard1" runat="server" ActiveStepIndex="0" class="table table-striped table-advance table-hover" OnNextButtonClick="Wizard1_NextButtonClick" OnFinishButtonClick="Wizard1_FinishButtonClick"  DisplaySideBar="false" OnPreRender="Wizard1_PreRender"><NavigationButtonStyle  BorderColor="Blue" />
                                            <WizardSteps>
