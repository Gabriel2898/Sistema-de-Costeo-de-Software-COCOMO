<%@ Page Title="" Language="C#" MasterPageFile="~/GACC_LiderProyectoInsertarActividad.Master" AutoEventWireup="true" CodeBehind="GACC_LiderProyectoInsertarActividad.aspx.cs" Inherits="GACC_Vista.GACC_LiderProyectoInsertarActividad1" %>
            ...
            <table style="width:100%" class="table table-striped table-advance table-hover">
                ...
                <tr>
                    <td>
                        ...
                        <asp:LinkButton ID="gacc_lnkactividad" runat="server" OnClick="gacc_lnkactividad_Click"  class="btn btn-danger btn-sm" ><i class="fa fa-plus" aria-hidden="true">Agregar Tarea</i></asp:LinkButton>
