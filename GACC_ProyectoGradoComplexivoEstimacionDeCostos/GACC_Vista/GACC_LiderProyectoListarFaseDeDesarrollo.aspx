<%@ Page Title="" Language="C#" MasterPageFile="~/GACC_LiderProyectoListarFaseDeDesarrollo.Master" AutoEventWireup="true" CodeBehind="GACC_LiderProyectoListarFaseDeDesarrollo.aspx.cs" Inherits="GACC_Vista.GACC_LiderProyectoListarFaseDeDesarrollo1" %>
...
<asp:Content ID="Content4" ContentPlaceHolderID="gacc_cph3" runat="server">
   ...
   <table class="auto-style3">
       ...
       <tr>
           <td>
               <table  class="table table-striped table-advance table-hover" style="margin-bottom: 63px; width: 95%; height: 444px; margin-right: 23px;">
                   <tr>
                       <td>Buscar por:</td>
                           <td>
